...
public class ExchangeService implements IExchangeService{
	...
	/*
	 * (non-Javadoc)
	 * @see com.jpmc.stockmarket.exchange.IExchangeService#fetchDataFromExchange(com.jpmc.stockmarket.exchange.ExchangeCode)
	 */
	@Override
	public ConcurrentHashMap<String, Stock> getDataFromExchange(ExchangeCode exchange) {
	...
	/*
	 * (non-Javadoc)
	 * @see com.jpmc.stockmarket.exchange.IExchangeService#updateStockTickerPrice(com.jpmc.stockmarket.model.Stock)
	 */
	@Override
