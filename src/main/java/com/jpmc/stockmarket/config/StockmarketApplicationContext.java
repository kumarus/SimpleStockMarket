...
@ComponentScan(basePackages = {
        "com.jpmc.stockmarket.exchange",
		"com.jpmc.stockmarket.service"
})
public class StockmarketApplicationContext {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			double result = stockMarket.executeFormulaRequest(FormulaRequest.DividendYield, "GIN", 60);
			 ...
			 */
			result = stockMarket.executeFormulaRequest(FormulaRequest.DividendYield, "ALE", 70);
			LOGGER.debug("{} = {} ",FormulaRequest.DividendYield.name(),result);
			
			/*
			 *  [R] a[ii] - For a given stock, Given any price as input, calculate the P/E Ratio
			 */
			result = stockMarket.executeFormulaRequest(FormulaRequest.PERatio, "ALE", 75);
